...
//////////////////////////////////////////////////////////////////////////
// AMultiPlayerNetGameCharacter

AMultiPlayerNetGameCharacter::AMultiPlayerNetGameCharacter()
{
...
void AMultiPlayerNetGameCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMultiPlayerNetGameCharacter::Move);
...
void AMultiPlayerNetGameCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
